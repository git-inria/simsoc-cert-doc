...
%Even if our goal is just to import a value (which at least is \emph{convertible} to the one we have defined), as it is the case of CompCert, there is a need to have a printer which output terms readingly.
% is defined using the raw constructorThis lead us to the 
\end{itemize}
